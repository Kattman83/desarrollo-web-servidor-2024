...
<body>
    ...
    if(!isset($_GET["befTip"])) {
        $type=$_COOKIE["befTip"]; 
    }else{
        $type=$_GET["befTip"];
    }
    
    setcookie("befTip",$type);
    setcookie("befP",$pag);
    ?>
    <div class="container">
        <form method="get">
            <label>
            <input type="radio" name="befTip" value="peliculas">
            Películas
            </label>
            <label>
            <input type="radio" name="befTip" value="series">
            Series
            </label>
            <label>
            <input type="radio" name="befTip" value="todos">
            Todos
            </label>
            <input type="numeric" name="pagina" value="<?php 
                if(isset($_GET["nextP"])){
                    echo $_GET["nextP"];
                    }else{
                        echo 1;
        ...
        if($pag==1){
            ...
            <div class="container">
                <form>
                    ...
                    <a class="btn btn-secondary" type="submit" name="nextP" href="nextPage_anime2.php?P=<?php echo urlencode($pag); ?>&nextTip=<?php echo urlencode($type) ?>" >Siguiente pagina</a>
                </form>
            </div>
            <?php
        }
